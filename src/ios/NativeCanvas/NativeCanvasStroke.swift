...
class StrokeCollection {
    var strokes: [NativeCanvasStroke] = []
    var activeStroke: NativeCanvasStroke?
...
extension NativeCanvasStroke : Sequence {
