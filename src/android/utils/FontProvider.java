...
public class FontProvider {
    ...
    public FontProvider(Resources resources) {
        ...
        // populate fonts
        fontNameToTypefaceFile = new HashMap<String, String>();
        ...
        fontNames = new ArrayList<String>(fontNameToTypefaceFile.keySet());
    }
        ...
        if (TextUtils.isEmpty(typefaceName)) {
            ...
            if (typefaces.get(typefaceName) == null) {
                typefaces.put(typefaceName,
                        Typeface.createFromAsset(resources.getAssets(), "www/assets/fonts/nativecanvas/" + fontNameToTypefaceFile.get(typefaceName)));
            }
