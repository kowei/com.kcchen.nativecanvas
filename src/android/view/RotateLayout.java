...
//    a.recycle();
  ...
  public void setDimention(NCRect displayRect) {
    if(this.getLayoutParams().width != (int) displayRect.width()
            || this.getLayoutParams().height != (int) displayRect.height()
            || this.getX() != displayRect.left()
            || this.getY() != displayRect.top()
            ){
      setX(displayRect.left());
      setY(displayRect.top());
      getLayoutParams().width = (int) displayRect.width();
      getLayoutParams().height = (int) displayRect.height();
      updateUI();
    }
  }

  public void setDimention(NCRect displayRect, int angle) {
