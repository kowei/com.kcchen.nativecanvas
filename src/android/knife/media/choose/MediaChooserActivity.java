...
import com.kcchen.nativecanvas.knife.media.choose.AudioChooserManager.AudioChooserListener;
import com.kcchen.nativecanvas.knife.media.choose.ImageChooserManager.ImageChooserListener;
import com.kcchen.nativecanvas.knife.media.choose.VideoChooserManager.VideoChooserListener;
import com.kcchen.nativecanvas.knife.media.crop.CropImageActivity;
...
public class MediaChooserActivity extends MonitoredActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            mMediaAction = mediaAction == null ? null : Constants.MediaAction.valueOf(mediaAction);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == Constants.MediaAction.PICK_PICTURE.requestCode() && data != null) {
                mMediaChooserMgr.processMedia(Constants.MediaAction.PICK_PICTURE, data);
            } else if (requestCode == Constants.MediaAction.CAPTURE_PICTURE.requestCode()) {
                mMediaChooserMgr.processMedia(Constants.MediaAction.CAPTURE_PICTURE, data);    // data may be null here
    ...
    public void onImageChosen(final RTImage image) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (mMediaAction == Constants.MediaAction.CAPTURE_PICTURE) {
