...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.nc_camera_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.nc_camera_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.nc_indicator_autocrop);
    }
