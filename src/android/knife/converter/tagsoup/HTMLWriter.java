...
package com.kcchen.nativecanvas.knife.converter.tagsoup;
...
public class HTMLWriter extends XMLFilterImpl implements LexicalHandler {
     ...
     * @throws SAXException If there is an error writing the attribute list, this
     ...
     * @throws SAXException If there is an error writing the characters, this method
     *                              will throw an IOException wrapped in a SAXException.
     */
